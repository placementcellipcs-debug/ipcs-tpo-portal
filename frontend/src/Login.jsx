...
export default function Login() {
  ...
  // 🚨 SPLASH SCREEN STATE (Plays video on startup)
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      console.error(err);
      // Detailed error for Render cold-starts
      setError('Server is waking up. Please wait 30 seconds and try clicking Sign In again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      ...
      {/* MAIN LOGIN PAGE */}
      <div style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden', background: 'radial-gradient(circle at top left, #1e293b, #020617)', fontFamily: 'Inter, sans-serif' }}>
            ...
            <div style={{ position: 'relative', height: '450px', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              ...
              <div style={{ 
                ...
                <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  ...
                  >
                    {loading ? <><CircleNotch size={20} className="ph-spin" /> Waking Server...</> : 'Sign In'}
                  </button>
                </form>
