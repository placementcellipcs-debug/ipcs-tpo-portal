...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      // 🚨 Ensure it waits for the server to wake up without throwing early errors
      ...
      setError(err.response?.data?.message || 'Server is waking up... Please try again in 10 seconds.');
      setLoading(false);
    }
  };
