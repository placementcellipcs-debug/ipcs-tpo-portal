...
export default function Clients() {
  ...
  useEffect(() => { 
    const fetchClientsInitial = async () => {
      ...
      const localUpperRole = String(localTpo.role || '').toUpperCase();
    ...
    <Layout>
      <div className="premium-dashboard-wrapper page-container" style={{ maxWidth: '1600px', margin: '0 auto', paddingBottom: '50px' }}>
        ...
        {loading ? (
          ...
          <div className="empty-state-card"><span style={{ fontSize: '2.5rem', marginBottom: '10px', display: 'block' }}>🏢</span>No companies found.</div>
        ) : (
