...
export default function Login() {
  ...
  return (
    <div className="tz-login-bg">
      <header className="tz-login-header">
        <img src="https://lh3.googleusercontent.com/d/1VqmH9-l2lBHErJPW1tCjtCu-SrTEMPtN" alt="IPCS Logo" className="tz-logo" />
      </header>
        ...
        <div className="tz-right">
          <div className="tz-card">
            ...
            <div style={{ textAlign: 'center', marginBottom: '30px' }}>
              <img src="https://lh3.googleusercontent.com/d/1VqmH9-l2lBHErJPW1tCjtCu-SrTEMPtN" alt="IPCS Logo" className="tz-logo" style={{ marginBottom: '15px' }} />
            ...
            <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
              <div>
                <label style={{ display: 'block', color: '#cbd5e1', fontSize: '0.8rem', fontWeight: 'bold', textAlign: 'left' }}>OFFICIAL EMAIL</label>
                <input 
                  type="text" 
                  value={loginId} 
              ...
              <div>
                <label style={{ display: 'block', color: '#cbd5e1', fontSize: '0.8rem', fontWeight: 'bold', textAlign: 'left' }}>PASSWORD</label>
                <input 
                  type="password" 
                  value={password} 
              ...
              <button type="submit" disabled={loading} className="tz-btn">
