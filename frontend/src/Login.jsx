  ...
  return (
    ...
    <div style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden', backgroundColor: '#020617', fontFamily: 'Inter, sans-serif' }}>
      ...
      >
        ...
        {/* Replace this src with your specific video URL if you have a different one */}
          ...
          <div style={{ background: '#0f172a', border: '1px solid #1e293b', borderRadius: '24px', padding: '40px', width: '100%', maxWidth: '400px', position: 'relative', boxShadow: '0 25px 50px rgba(0,0,0,0.8)' }}>
            ...
            <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <button
                ...
                style={{ width: '100%', background: '#3b82f6', color: '#fff', border: 'none', padding: '14px', borderRadius: '10px', fontSize: '1rem', fontWeight: 'bold', cursor: 'pointer', display: 'flex', justifyContent: 'center', marginTop: '10px' }}

              >

                {loading ? <CircleNotch size={20} className="ph-spin" /> : 'Sign In'}
