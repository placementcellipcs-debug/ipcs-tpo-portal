...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      // 🚨 Increase timeout drastically to allow Render to wake up
      ...
      // Give the actual robust error
      setError(err.response?.data?.message || 'Connecting... Please click Sign In again if it fails.');
      setLoading(false);
    }
  };
