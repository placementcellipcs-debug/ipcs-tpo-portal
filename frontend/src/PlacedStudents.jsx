...
export default function PlacedStudents() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.post('http://localhost:5000/api/tpo/applications', { 
  ...
  const submitEdit = async () => {
    ...
    try {
      ...
      await axios.post('http://localhost:5000/api/tpo/applications/update', formData, { headers: { 'Content-Type': 'multipart/form-data' }});
  ...
  const submitAdd = async () => {
    ...
    try {
      ...
      await axios.post('http://localhost:5000/api/tpo/applications/add', formData, { headers: { 'Content-Type': 'multipart/form-data' }});
